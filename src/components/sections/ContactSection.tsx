          ...
          <div className="lg:col-span-3">
            {status === 'sent' ? (
              <div className="rounded-2xl p-8 text-center" style={{ background: 'var(--accent-dim)', border: '1px solid var(--accent-glow)' }}>
                ...
                <button onClick={() => setStatus('idle')} className="mt-4 text-sm" style={{ color: 'var(--accent)' }}>Send another message</button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-display)' }}>Name</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-display)' }}>Email</label>
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-display)' }}>Subject</label>
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-display)' }}>Message</label>
                ...
                <button type="submit" disabled={status === 'sending'} className="flex items-center gap-4 btn-primary w-full justify-center py-3 text-base">
